...
import type { CameraAnimation, ParticleMesh } from "./common/types"
import { images, perspectives, cylinderConfig, particleConfig, imageConfig } from "./common/data"
import {
  drawImageCover,
  getPositionClasses,
...
import { CodropsFrame } from "./common/codrops-frame"
  ...
  return (
    <>
      ...
      <CodropsFrame
        ...
        demos={[
          { label: "Title 1", href: "/", current: true },
          { label: "Title 2", href: "/", current: false },
        ]}
