...
export function VietnamComponent() {
        ...
        <div>
          ...
          <ScrollText duration={2} from={"left"} distance={200}>
            <p className="max-w-[900px] mt-10 text-white">
              Mù Cang Chải là một huyện vùng cao thuộc tỉnh Yên Bái, nổi tiếng với những thửa ruộng
              bậc thang đẹp như tranh vẽ và sự phong phú trong văn hóa của các cộng đồng dân tộc
              thiểu số. Nơi đây cách Hà Nội khoảng 300 km về phía Tây Bắc, thu hút đông đảo du khách
              nhờ vẻ đẹp thiên nhiên hùng vĩ và các lễ hội đặc sắc như Festival Khèn Mông và Lễ hội
              hoa Tớ Dày. Mù Cang Chải không chỉ là điểm đến lý tưởng cho những ai yêu thích thiên
              nhiên mà còn là nơi để khám phá văn hóa độc đáo của đồng bào dân tộc H’Mông.
            </p>
          </ScrollText>
